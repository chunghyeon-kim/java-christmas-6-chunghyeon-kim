...
public class Order {
    private static final int TOTAL_MENU_UPPER_LIMIT = 20;
    private static final String MENU_OVER_LIMIT = "[ERROR] 메뉴는 20개를 초과할 수 없습니다.";
    ...
    public void isOverLimit() {
        ...
        if (count.get() > TOTAL_MENU_UPPER_LIMIT) {
            throw new IllegalArgumentException(MENU_OVER_LIMIT);
        }
    }
